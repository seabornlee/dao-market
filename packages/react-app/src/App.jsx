...
import { Alert, Button, Input, Col, Menu, Row, List } from "antd";
  ...
  */
  ...
  return (
    <div className="App">
      <BrowserRouter>
        <div>
          <div style={{ display: "flex", background: "rgba(29, 33, 41, 1)",height: 70 }}>
            <HeaderLeft />
            <HeaderMid />
            <HeaderRight /> 
          </div>
 ...
 */}
      ...
      <div style={{ position: "absolute", textAlign: "center", right: 0, top: 6, padding: 10 }}>
        <Account
          address={address}
